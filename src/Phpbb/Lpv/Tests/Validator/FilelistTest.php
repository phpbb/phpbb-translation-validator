 ...
 *
 */
namespace Phpbb\Lpv\Tests\Validator;

use Phpbb\Lpv\Output\Output;

class FilelistTest extends \Phpbb\Lpv\Tests\TestBase
{
	...
	*/
	...
	{
		$validator = new \Phpbb\Lpv\Validator\FilelistValidator($this->getMock('Symfony\Component\Console\Input\InputInterface'), $this->output, 'origin', 'source', dirname(__FILE__) . '/fixtures/', $phpbbVersion, false);
		$validator->validate();
