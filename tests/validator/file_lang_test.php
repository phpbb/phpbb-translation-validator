...
class phpbb_ext_official_translationvalidator_tests_validator_file_lang_test extends phpbb_ext_official_translationvalidator_tests_validator_test_base
{
	...
	*/
	...
	{
		$this->validator->validate_lang_file($file);
