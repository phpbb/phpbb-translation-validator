	...
	static public function validate_array_key_data()
	{
		return array(
			...
			array('String-Array', 'foobar', array(), array(
				array('fail', 'INVALID_TYPE--String-Array-string-array'),
			)),
			array('Array-String', array(), 'foobar', array(
				array('fail', 'INVALID_TYPE--Array-String-array-string'),
			)),
			array('String-Int', 'foobar', 0, array(
				array('fail', 'INVALID_TYPE--String-Int-string-integer'),
			)),
			array('Int-String', 0, 'foobar', array(
				array('fail', 'INVALID_TYPE--Int-String-integer-string'),
			)),
			array('Array-Int', array(), 0, array(
				array('fail', 'INVALID_TYPE--Array-Int-array-integer'),
			)),
			array('Int-Array', 0, array(), array(
				array('fail', 'INVALID_TYPE--Int-Array-integer-array'),
			)),

			// Missing keys
			array('MissingKey', array('foo' => 'bar'), array('bar' => 'bar2'), array(
				array('fail', 'LANG_ARRAY_MISSING--MissingKey-foo'),
				array('fail', 'LANG_ARRAY_INVALID--MissingKey-bar'),
				array('warning', 'KEY_NOT_VALIDATED--MissingKey.bar'),
			)),
