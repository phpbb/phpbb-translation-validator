...
class phpbb_ext_official_translationvalidator_tests_validator_file_help_test extends phpbb_ext_official_translationvalidator_tests_validator_file_test_base
{
	...
	*/
	...
	{
		$this->validator->validate_help_file($file);
